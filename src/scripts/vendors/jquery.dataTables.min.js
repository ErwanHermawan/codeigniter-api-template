...
(function (h) {
	...
	function ma(a) {
		...
		if (a.scrollBarVis !== L && a.scrollBarVis !== k)
			...
			u &&
				((Q = u.clone().prependTo(o)), (P = u.find("tr")), (Q = Q.find("tr")));
	...
	var m = function (a) {
			...
			this.each(function () {
				...
				if ("table" != this.nodeName.toLowerCase())
					...
					var u = o.oClasses;
					g.bJQueryUI
						? (h.extend(u, m.ext.oJUIClasses, g.oClasses),
						  g.sDom === l.sDom &&
								"lfrtip" === l.sDom &&
								(o.sDom = '<"H"lfr>t<"F"ip>'),
						  o.renderer)
					...
					null === g.asStripeClasses &&
						(o.asStripeClasses = [u.sStripeOdd, u.sStripeEven]);
						...
						if (a === null || a === k || c) {
							...
							for (u = g.length; p < u; p++) {
								...
								for (t = 0; t < n; t++) {
									...
									if (c) {
										v = f[l];
										a(s, B(b, l, t), v.anCells ? v.anCells[t] : null) &&
											m.push(s);
									} else m.push(s);
								}
							}
