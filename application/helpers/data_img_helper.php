...
if (!function_exists('upload_img')) {
   ...
   */
  function upload_img(string $value_name, string $dir_file, int $id_file = 0, string $dir_base = 'default', int $max_size = 2000, int $max_width = 5120): object {
    ...
    $file_ext = strtolower(pathinfo($file_name, PATHINFO_EXTENSION)); // Use strtolower for consistency
...
if (!function_exists('update_img')) {
   ...
   */
  function update_img(string $dir_file, string $tmp_file, string $new_file, int $width = 1024, string $dir_base = 'default'): array {
...
if (!function_exists('delete_img')) {
   ...
   * @return void
   */
  function delete_img(string $dir_file, string $file_name, string $dir_base = 'default'): void {
...
if (!function_exists('upload_file')) {
   ...
   */
  function upload_file(string $value_name, string $dir_file, int $id_file = 0, int $max_size = 4096, string $dir_base = 'default'): object {
    ...
    $files_result = $files_config . $file_name;
